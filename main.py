...
if __name__ == "__main__":
    try:
        client_thread = FF_CLIENT(id="4418774874", password="JOBAYAR_CODX-SKIT0QITR")
        client_thread.start()
    except Exception as e:
        logging.error(f"Error occurred: {e}")

        client_thread = FF_CLIENT(id="4418775206", password="JOBAYAR_CODX-7LR2MFZOU")
        client_thread.start()
    except Exception as e:
        logging.error(f"Error occurred: {e}")
        
        client_thread = FF_CLIENT(id="4418775397", password="JOBAYAR_CODX-P20TYJZCG")
        client_thread.start()
    except Exception as e:
        logging.error(f"Error occurred: {e}")
        
        client_thread = FF_CLIENT(id="4418775851", password="JOBAYAR_CODX-QQLI8Q3Z4")
